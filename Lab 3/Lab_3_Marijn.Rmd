...
q_learning <- function(start_state, epsilon = 0.5, alpha = 0.1, gamma = 0.95, 
  ...
  repeat{
    ...
    # Q-table update.
    corr_term[i] <- reward + gamma * max(q_table[next_state[1], next_state[2],]) - q_table[state[1], state[2], e_greedy_action]
    q_table[state[1], state[2], e_greedy_action] <<- q_table[state[1], state[2], e_greedy_action] + alpha * (corr_term[i])
    ...
    if(reward != 0) {
      # End episode.
      episode_correction <- sum(corr_term)
